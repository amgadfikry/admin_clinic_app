...
import {
  specialitiesDataState, useSelector, useState, Link, baseUrl, useCookies, LoadingComponent,
  AiOutlineDelete, AiOutlineEdit, ConfirmMsg, deleteSpeciality, useDispatch,
  setspecialitiesData, useEffect
} from '../../import'
